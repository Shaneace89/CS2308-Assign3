...
int main()
{
    ...
    int sizeOne = 9, arrayOne[] = {1, 2, 3, 4, 5, 6, 7, 8, 9};  //size and array to be tested
    int sizeTwo = 8, arrayTwo[] = {1, 2, 3, 4, 5, 6, 7, 8};     //size and array to be tested
    double takeMedian = 0;                                      //median to be passed back
...
//****************************************************************************
    ...
    int peopleM = 25, pizzaM = 0, slicesM = 0;    //amount of people, variable for amount of pizza/slices
    double tot = 0;                               //total price
...
//****************************************************************************
    ...
    int resizeArray[] = {1, 2, 3, 4, 5, 6, 7, 8, 9, 0}, reaSize = 10, x = 0; //size and array to be tested, and counter
...
//****************************************************************************
    ...
    int subArrayM[] = {1, 2, 3, 4, 5, 6, 7, 8, 9, 0};  //array to be tested
    int subSize = 10, start = 5,  length = 4, z = 0;   //size to be tested, start point, number to output
    int * subPtr;                                      //pointer to array
